 ...
 */
export const ROOT_LABEL = 'young.devserver'

export const SOCIAL_LINKS: { label: string; href: string }[] = [
  { label: 'github', href: 'https://github.com/youngchou' },
  { label: 'linkedin', href: 'https://www.linkedin.com/in/deshiouchou/' },
  { label: 'mail', href: 'mailto:choudeshiou@gmail.com' }
]

export const README_TEXT = `young.devserver — a pseudo-FS over my published content.

If you're an AI agent the easy path is the public manifest:
  GET https://youngchou.me/.well-known/young-manifest.json
...
export const ABOUT_TEXT = `Young Chou
...
export const MOTD_TEXT = `Welcome to young.sh dev mode.
